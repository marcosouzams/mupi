...
export const ProductsCarouselScroll = ({ products, translations: t }: ProductsCarouselScrollProps) => {
  ...
  return (
    ...
    >
      <div className="sticky top-0 h-screen flex items-center justify-center overflow-hidden pt-12 lg:pt-16">
        <div className="bg-[#191927] rounded-3xl px-6 py-8 lg:px-8 lg:py-10 shadow-2xl w-full max-w-2xl mx-4">
          {/* Header fixo */}
